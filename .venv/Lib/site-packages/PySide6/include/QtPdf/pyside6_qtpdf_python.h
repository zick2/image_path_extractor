...
enum : int {
    ...
    SBK_QPDFLINK_IDX                                         = 9,
    SBK_QPDFPAGENAVIGATOR_IDX                                = 10,
    SBK_QPDFPAGERENDERER_RENDERMODE_IDX                      = 12,
    SBK_QPDFPAGERENDERER_IDX                                 = 11,
    SBK_QPDFSEARCHMODEL_ROLE_IDX                             = 14,
    SBK_QPDFSEARCHMODEL_IDX                                  = 13,
    SBK_QPDFSELECTION_IDX                                    = 15,
    SBK_QtPdf_IDX_COUNT                                      = 16
};
