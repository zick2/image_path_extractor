...
enum : int {
    ...
    SBK_QT3DEXTRAS_QLIST_QT3DCORE_QATTRIBUTEPTR_IDX          = 1, // QList<Qt3DCore::QAttribute* >
    SBK_QT3DEXTRAS_QLIST_QT3DRENDER_QPARAMETERPTR_IDX        = 2, // QList<Qt3DRender::QParameter* >
    SBK_QT3DEXTRAS_QLIST_QT3DCORE_QCOMPONENTPTR_IDX          = 3, // QList<Qt3DCore::QComponent* >
    SBK_QT3DEXTRAS_QLIST_QT3DCORE_QNODEPTR_IDX               = 4, // QList<Qt3DCore::QNode* >
    SBK_QT3DEXTRAS_QLIST_QT3DRENDER_QFILTERKEYPTR_IDX        = 5, // QList<Qt3DRender::QFilterKey* >
    SBK_QT3DEXTRAS_QLIST_QT3DEXTRAS_QSPRITESHEETITEMPTR_IDX  = 6, // QList<Qt3DExtras::QSpriteSheetItem* >
