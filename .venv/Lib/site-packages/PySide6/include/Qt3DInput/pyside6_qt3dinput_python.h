...
enum : int {
    ...
    SBK_QT3DINPUT_QLIST_QT3DCORE_QENTITYPTR_IDX              = 1, // QList<Qt3DCore::QEntity* >
    SBK_QT3DINPUT_QLIST_QOBJECTPTR_IDX                       = 2, // QList<QObject* >
    SBK_QT3DINPUT_QLIST_QBYTEARRAY_IDX                       = 3, // QList<QByteArray >
    SBK_QT3DINPUT_QLIST_QT3DINPUT_QACTIONPTR_IDX             = 4, // QList<Qt3DInput::QAction* >
    SBK_QT3DINPUT_QLIST_QT3DINPUT_QAXISPTR_IDX               = 5, // QList<Qt3DInput::QAxis* >
    SBK_QT3DINPUT_QLIST_QT3DCORE_QNODEPTR_IDX                = 6, // QList<Qt3DCore::QNode* >
    SBK_QT3DINPUT_QLIST_QT3DINPUT_QABSTRACTAXISINPUTPTR_IDX  = 7, // QList<Qt3DInput::QAbstractAxisInput* >
    SBK_QT3DINPUT_QLIST_QT3DINPUT_QABSTRACTACTIONINPUTPTR_IDX = 8, // QList<Qt3DInput::QAbstractActionInput* >
    SBK_QT3DINPUT_QLIST_QT3DINPUT_QAXISSETTINGPTR_IDX        = 9, // QList<Qt3DInput::QAxisSetting* >
