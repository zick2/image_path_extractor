...
enum : int {
    ...
    SBK_QTWIDGETS_QPAIR_QACCESSIBLEINTERFACEPTR_QFLAGS_QACCESSIBLE_RELATIONFLAG_IDX = 3, // QPair<QAccessibleInterface*,QFlags<QAccessible::RelationFlag> >
    SBK_QTWIDGETS_QLIST_QPAIR_QACCESSIBLEINTERFACEPTR_QFLAGS_QACCESSIBLE_RELATIONFLAG_IDX = 4, // QList<QPair< QAccessibleInterface*,QFlags<QAccessible::RelationFlag> > >
    ...
    SBK_QTWIDGETS_QLIST_QMODELINDEX_IDX                      = 20, // QList<QModelIndex >
    SBK_QTWIDGETS_QLIST_QTABLEWIDGETITEMPTR_IDX              = 21, // QList<QTableWidgetItem* >
    SBK_QTWIDGETS_QLIST_QTABLEWIDGETSELECTIONRANGE_IDX       = 22, // QList<QTableWidgetSelectionRange >
    SBK_QTWIDGETS_QLIST_QLISTWIDGETITEMPTR_IDX               = 23, // QList<QListWidgetItem* >
    SBK_QTWIDGETS_QLIST_QABSTRACTBUTTONPTR_IDX               = 24, // QList<QAbstractButton* >
    SBK_QTWIDGETS_QLIST_QWIZARD_WIZARDBUTTON_IDX             = 25, // QList<QWizard::WizardButton >
    SBK_QTWIDGETS_QMAP_QDATE_QTEXTCHARFORMAT_IDX             = 26, // QMap<QDate,QTextCharFormat >
    SBK_QTWIDGETS_QLIST_QSCROLLERPTR_IDX                     = 27, // QList<QScroller* >
    SBK_QTWIDGETS_QLIST_QREAL_IDX                            = 28, // QList<qreal >
    SBK_QTWIDGETS_QLIST_QGRAPHICSVIEWPTR_IDX                 = 29, // QList<QGraphicsView* >
    SBK_QTWIDGETS_QPAIR_QREAL_QPOINTF_IDX                    = 30, // QPair<qreal,QPointF >
    SBK_QTWIDGETS_QLIST_QPAIR_QREAL_QPOINTF_IDX              = 31, // QList<QPair< qreal,QPointF > >
    SBK_QTWIDGETS_QPAIR_QREAL_QREAL_IDX                      = 32, // QPair<qreal,qreal >
    SBK_QTWIDGETS_QLIST_QPAIR_QREAL_QREAL_IDX                = 33, // QList<QPair< qreal,qreal > >
    SBK_QTWIDGETS_QLIST_QKEYSEQUENCE_IDX                     = 34, // QList<QKeySequence >
    SBK_QTWIDGETS_QLIST_QGESTUREPTR_IDX                      = 35, // QList<QGesture* >
    SBK_QTWIDGETS_QLIST_QWINDOWPTR_IDX                       = 36, // QList<QWindow* >
    SBK_QTWIDGETS_QLIST_QSCREENPTR_IDX                       = 37, // QList<QScreen* >
    SBK_QTWIDGETS_QLIST_QURL_IDX                             = 38, // QList<QUrl >
    SBK_QTWIDGETS_QMAP_INT_QVARIANT_IDX                      = 39, // QMap<int,QVariant >
    SBK_QTWIDGETS_QLIST_QPERSISTENTMODELINDEX_IDX            = 40, // QList<QPersistentModelIndex >
