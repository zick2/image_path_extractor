...
enum : int {
    ...
    SBK_QT3DANIMATION_QLIST_QT3DCORE_QATTRIBUTEPTR_IDX       = 1, // QList<Qt3DCore::QAttribute* >
    SBK_QT3DANIMATION_QLIST_QOBJECTPTR_IDX                   = 2, // QList<QObject* >
    SBK_QT3DANIMATION_QLIST_QBYTEARRAY_IDX                   = 3, // QList<QByteArray >
    SBK_QT3DANIMATION_QLIST_QT3DANIMATION_QANIMATIONGROUPPTR_IDX = 4, // QList<Qt3DAnimation::QAnimationGroup* >
    SBK_QT3DANIMATION_QLIST_QT3DANIMATION_QABSTRACTANIMATIONPTR_IDX = 5, // QList<Qt3DAnimation::QAbstractAnimation* >
    SBK_QT3DANIMATION_QLIST_QT3DCORE_QNODEPTR_IDX            = 6, // QList<Qt3DCore::QNode* >
    SBK_QT3DANIMATION_QLIST_QT3DCORE_QENTITYPTR_IDX          = 7, // QList<Qt3DCore::QEntity* >
    SBK_QT3DANIMATION_QLIST_QT3DANIMATION_QABSTRACTCHANNELMAPPINGPTR_IDX = 8, // QList<Qt3DAnimation::QAbstractChannelMapping* >
    SBK_QT3DANIMATION_QLIST_QT3DANIMATION_QMORPHTARGETPTR_IDX = 9, // QList<Qt3DAnimation::QMorphTarget* >
    SBK_QT3DANIMATION_QLIST_FLOAT_IDX                        = 10, // QList<float >
    SBK_QT3DANIMATION_QLIST_QT3DCORE_QTRANSFORMPTR_IDX       = 11, // QList<Qt3DCore::QTransform* >
    SBK_QT3DANIMATION_QLIST_QVARIANT_IDX                     = 12, // QList<QVariant >
    SBK_QT3DANIMATION_QLIST_QSTRING_IDX                      = 13, // QList<QString >
    SBK_QT3DANIMATION_QMAP_QSTRING_QVARIANT_IDX              = 14, // QMap<QString,QVariant >
    SBK_Qt3DAnimation_CONVERTERS_IDX_COUNT                   = 15
};
