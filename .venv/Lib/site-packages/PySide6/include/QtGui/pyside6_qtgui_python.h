...
enum : int {
    ...
    SBK_QFOCUSEVENT_IDX                                      = 91,
    SBK_QFONT_STYLEHINT_IDX                                  = 97,
    SBK_QFONT_STYLESTRATEGY_IDX                              = 98,
    SBK_QFONT_HINTINGPREFERENCE_IDX                          = 352,
    SBK_QFONT_WEIGHT_IDX                                     = 99,
    SBK_QFONT_STYLE_IDX                                      = 96,
    SBK_QFONT_STRETCH_IDX                                    = 95,
    SBK_QFONT_CAPITALIZATION_IDX                             = 93,
    SBK_QFONT_SPACINGTYPE_IDX                                = 94,
    SBK_QFONT_IDX                                            = 92,
    SBK_QFONTDATABASE_WRITINGSYSTEM_IDX                      = 102,
    SBK_QFONTDATABASE_SYSTEMFONT_IDX                         = 101,
    SBK_QFONTDATABASE_IDX                                    = 100,
    SBK_QFONTINFO_IDX                                        = 103,
    SBK_QFONTMETRICS_IDX                                     = 104,
    SBK_QFONTMETRICSF_IDX                                    = 105,
    SBK_QGLYPHRUN_GLYPHRUNFLAG_IDX                           = 107,
    SBK_QFLAGS_QGLYPHRUN_GLYPHRUNFLAG_IDX                    = 73,
    SBK_QGLYPHRUN_IDX                                        = 106,
    SBK_QGRADIENT_TYPE_IDX                                   = 113,
    SBK_QGRADIENT_SPREAD_IDX                                 = 112,
    SBK_QGRADIENT_COORDINATEMODE_IDX                         = 109,
    SBK_QGRADIENT_INTERPOLATIONMODE_IDX                      = 110,
    SBK_QGRADIENT_PRESET_IDX                                 = 111,
    SBK_QGRADIENT_IDX                                        = 108,
    SBK_QGUIAPPLICATION_IDX                                  = 114,
    SBK_QHELPEVENT_IDX                                       = 115,
    SBK_QHIDEEVENT_IDX                                       = 116,
    SBK_QHOVEREVENT_IDX                                      = 117,
    SBK_QICON_MODE_IDX                                       = 119,
    SBK_QICON_STATE_IDX                                      = 120,
    SBK_QICON_IDX                                            = 118,
    SBK_QICONDRAGEVENT_IDX                                   = 121,
    SBK_QICONENGINE_ICONENGINEHOOK_IDX                       = 123,
    SBK_QICONENGINE_IDX                                      = 122,
    SBK_QICONENGINE_SCALEDPIXMAPARGUMENT_IDX                 = 124,
    SBK_QIMAGE_INVERTMODE_IDX                                = 127,
    SBK_QIMAGE_FORMAT_IDX                                    = 126,
    SBK_QIMAGE_IDX                                           = 125,
    SBK_QIMAGEIOHANDLER_IMAGEOPTION_IDX                      = 129,
    SBK_QIMAGEIOHANDLER_TRANSFORMATION_IDX                   = 130,
    SBK_QFLAGS_QIMAGEIOHANDLER_TRANSFORMATION_IDX            = 74,
    SBK_QIMAGEIOHANDLER_IDX                                  = 128,
    SBK_QIMAGEREADER_IMAGEREADERERROR_IDX                    = 132,
    SBK_QIMAGEREADER_IDX                                     = 131,
    SBK_QIMAGEWRITER_IMAGEWRITERERROR_IDX                    = 134,
    SBK_QIMAGEWRITER_IDX                                     = 133,
    SBK_QINPUTDEVICE_DEVICETYPE_IDX                          = 137,
    SBK_QFLAGS_QINPUTDEVICE_DEVICETYPE_IDX                   = 76,
    SBK_QINPUTDEVICE_CAPABILITY_IDX                          = 136,
    SBK_QFLAGS_QINPUTDEVICE_CAPABILITY_IDX                   = 75,
    SBK_QINPUTDEVICE_IDX                                     = 135,
    SBK_QINPUTEVENT_IDX                                      = 138,
    SBK_QINPUTMETHOD_ACTION_IDX                              = 140,
    SBK_QINPUTMETHOD_IDX                                     = 139,
    SBK_QINPUTMETHODEVENT_ATTRIBUTETYPE_IDX                  = 143,
    SBK_QINPUTMETHODEVENT_IDX                                = 141,
    SBK_QINPUTMETHODEVENT_ATTRIBUTE_IDX                      = 142,
    SBK_QINPUTMETHODQUERYEVENT_IDX                           = 144,
    SBK_QINTVALIDATOR_IDX                                    = 145,
    SBK_QKEYEVENT_IDX                                        = 146,
    SBK_QKEYSEQUENCE_STANDARDKEY_IDX                         = 150,
    SBK_QKEYSEQUENCE_SEQUENCEFORMAT_IDX                      = 148,
    SBK_QKEYSEQUENCE_SEQUENCEMATCH_IDX                       = 149,
    SBK_QKEYSEQUENCE_IDX                                     = 147,
    SBK_QLINEARGRADIENT_IDX                                  = 151,
    SBK_QMATRIX2X2_IDX                                       = 152,
    SBK_QGENERICMATRIX_2_2_FLOAT_IDX                         = 152,
    SBK_QMATRIX2X3_IDX                                       = 153,
    SBK_QGENERICMATRIX_2_3_FLOAT_IDX                         = 153,
    SBK_QMATRIX2X4_IDX                                       = 154,
    SBK_QGENERICMATRIX_2_4_FLOAT_IDX                         = 154,
    SBK_QMATRIX3X2_IDX                                       = 155,
    SBK_QGENERICMATRIX_3_2_FLOAT_IDX                         = 155,
    SBK_QMATRIX3X3_IDX                                       = 156,
    SBK_QGENERICMATRIX_3_3_FLOAT_IDX                         = 156,
    SBK_QMATRIX3X4_IDX                                       = 157,
    SBK_QGENERICMATRIX_3_4_FLOAT_IDX                         = 157,
    SBK_QMATRIX4X2_IDX                                       = 158,
    SBK_QGENERICMATRIX_4_2_FLOAT_IDX                         = 158,
    SBK_QMATRIX4X3_IDX                                       = 159,
    SBK_QGENERICMATRIX_4_3_FLOAT_IDX                         = 159,
    SBK_QMATRIX4X4_FLAG_IDX                                  = 161,
    SBK_QFLAGS_QMATRIX4X4_FLAG_IDX                           = 77,
    SBK_QMATRIX4X4_IDX                                       = 160,
    SBK_QMOUSEEVENT_IDX                                      = 162,
    SBK_QMOVEEVENT_IDX                                       = 163,
    SBK_QMOVIE_MOVIESTATE_IDX                                = 166,
    SBK_QMOVIE_CACHEMODE_IDX                                 = 165,
    SBK_QMOVIE_IDX                                           = 164,
    SBK_QNATIVEGESTUREEVENT_IDX                              = 167,
    SBK_QOFFSCREENSURFACE_IDX                                = 168,
    SBK_QOPENGLCONTEXT_OPENGLMODULETYPE_IDX                  = 170,
    SBK_QOPENGLCONTEXT_IDX                                   = 169,
    SBK_QOPENGLCONTEXTGROUP_IDX                              = 171,
    SBK_QOPENGLEXTRAFUNCTIONS_IDX                            = 172,
    SBK_QOPENGLFUNCTIONS_OPENGLFEATURE_IDX                   = 174,
    SBK_QFLAGS_QOPENGLFUNCTIONS_OPENGLFEATURE_IDX            = 78,
    SBK_QOPENGLFUNCTIONS_IDX                                 = 173,
    SBK_QPAGELAYOUT_UNIT_IDX                                 = 178,
    SBK_QPAGELAYOUT_ORIENTATION_IDX                          = 177,
    SBK_QPAGELAYOUT_MODE_IDX                                 = 176,
    SBK_QPAGELAYOUT_IDX                                      = 175,
    SBK_QPAGERANGES_IDX                                      = 179,
    SBK_QPAGERANGES_RANGE_IDX                                = 180,
    SBK_QPAGESIZE_PAGESIZEID_IDX                             = 182,
    SBK_QPAGESIZE_UNIT_IDX                                   = 184,
    SBK_QPAGESIZE_SIZEMATCHPOLICY_IDX                        = 183,
    SBK_QPAGESIZE_IDX                                        = 181,
    SBK_QPAGEDPAINTDEVICE_PDFVERSION_IDX                     = 186,
    SBK_QPAGEDPAINTDEVICE_IDX                                = 185,
    SBK_QPAINTDEVICE_PAINTDEVICEMETRIC_IDX                   = 188,
    SBK_QPAINTDEVICE_IDX                                     = 187,
    SBK_QPAINTDEVICEWINDOW_IDX                               = 189,
    SBK_QPAINTENGINE_PAINTENGINEFEATURE_IDX                  = 192,
    SBK_QFLAGS_QPAINTENGINE_PAINTENGINEFEATURE_IDX           = 80,
    SBK_QPAINTENGINE_DIRTYFLAG_IDX                           = 191,
    SBK_QFLAGS_QPAINTENGINE_DIRTYFLAG_IDX                    = 79,
    SBK_QPAINTENGINE_POLYGONDRAWMODE_IDX                     = 193,
    SBK_QPAINTENGINE_TYPE_IDX                                = 194,
    SBK_QPAINTENGINE_IDX                                     = 190,
    SBK_QPAINTENGINESTATE_IDX                                = 195,
    SBK_QPAINTEVENT_IDX                                      = 196,
    SBK_QPAINTER_RENDERHINT_IDX                              = 201,
    SBK_QFLAGS_QPAINTER_RENDERHINT_IDX                       = 82,
    SBK_QPAINTER_PIXMAPFRAGMENTHINT_IDX                      = 200,
    SBK_QFLAGS_QPAINTER_PIXMAPFRAGMENTHINT_IDX               = 81,
    SBK_QPAINTER_COMPOSITIONMODE_IDX                         = 198,
    SBK_QPAINTER_IDX                                         = 197,
    SBK_QPAINTER_PIXMAPFRAGMENT_IDX                          = 199,
    SBK_QPAINTERPATH_ELEMENTTYPE_IDX                         = 204,
    SBK_QPAINTERPATH_IDX                                     = 202,
    SBK_QPAINTERPATH_ELEMENT_IDX                             = 203,
    SBK_QPAINTERPATHSTROKER_IDX                              = 205,
    SBK_QPALETTE_COLORGROUP_IDX                              = 207,
    SBK_QPALETTE_COLORROLE_IDX                               = 208,
    SBK_QPALETTE_IDX                                         = 206,
    SBK_QPDFWRITER_IDX                                       = 209,
    SBK_QPEN_IDX                                             = 210,
    SBK_QPICTURE_IDX                                         = 211,
    SBK_QPIXELFORMAT_COLORMODEL_IDX                          = 217,
    SBK_QPIXELFORMAT_ALPHAUSAGE_IDX                          = 215,
    SBK_QPIXELFORMAT_ALPHAPOSITION_IDX                       = 213,
    SBK_QPIXELFORMAT_ALPHAPREMULTIPLIED_IDX                  = 214,
    SBK_QPIXELFORMAT_TYPEINTERPRETATION_IDX                  = 218,
    SBK_QPIXELFORMAT_YUVLAYOUT_IDX                           = 219,
    SBK_QPIXELFORMAT_BYTEORDER_IDX                           = 216,
    SBK_QPIXELFORMAT_IDX                                     = 212,
    SBK_QPIXMAP_IDX                                          = 220,
    SBK_QPIXMAPCACHE_IDX                                     = 221,
    SBK_QPIXMAPCACHE_KEY_IDX                                 = 222,
    SBK_QPLATFORMSURFACEEVENT_SURFACEEVENTTYPE_IDX           = 224,
    SBK_QPLATFORMSURFACEEVENT_IDX                            = 223,
    SBK_QPOINTEREVENT_IDX                                    = 225,
    SBK_QPOINTINGDEVICE_POINTERTYPE_IDX                      = 228,
    SBK_QFLAGS_QPOINTINGDEVICE_POINTERTYPE_IDX               = 83,
    SBK_QPOINTINGDEVICE_GRABTRANSITION_IDX                   = 227,
    SBK_QPOINTINGDEVICE_IDX                                  = 226,
    SBK_QPOINTINGDEVICEUNIQUEID_IDX                          = 229,
    SBK_QPOLYGON_IDX                                         = 230,
    SBK_QPOLYGONF_IDX                                        = 231,
    SBK_QPYTEXTOBJECT_IDX                                    = 232,
    SBK_QQUATERNION_IDX                                      = 233,
    SBK_QRADIALGRADIENT_IDX                                  = 234,
    SBK_QRASTERWINDOW_IDX                                    = 235,
    SBK_QRAWFONT_ANTIALIASINGTYPE_IDX                        = 237,
    SBK_QRAWFONT_LAYOUTFLAG_IDX                              = 238,
    SBK_QFLAGS_QRAWFONT_LAYOUTFLAG_IDX                       = 84,
    SBK_QRAWFONT_IDX                                         = 236,
    SBK_QREGION_REGIONTYPE_IDX                               = 240,
    SBK_QREGION_IDX                                          = 239,
    SBK_QREGULAREXPRESSIONVALIDATOR_IDX                      = 241,
    SBK_QRESIZEEVENT_IDX                                     = 242,
    SBK_QRGBA64_IDX                                          = 243,
    SBK_QSCREEN_IDX                                          = 244,
    SBK_QSCROLLEVENT_SCROLLSTATE_IDX                         = 246,
    SBK_QSCROLLEVENT_IDX                                     = 245,
    SBK_QSCROLLPREPAREEVENT_IDX                              = 247,
    SBK_QSESSIONMANAGER_RESTARTHINT_IDX                      = 249,
    SBK_QSESSIONMANAGER_IDX                                  = 248,
    SBK_QSHORTCUT_IDX                                        = 250,
    SBK_QSHORTCUTEVENT_IDX                                   = 251,
    SBK_QSHOWEVENT_IDX                                       = 252,
    SBK_QSINGLEPOINTEVENT_IDX                                = 253,
    SBK_QSTANDARDITEM_ITEMTYPE_IDX                           = 255,
    SBK_QSTANDARDITEM_IDX                                    = 254,
    SBK_QSTANDARDITEMMODEL_IDX                               = 256,
    SBK_QSTATICTEXT_PERFORMANCEHINT_IDX                      = 258,
    SBK_QSTATICTEXT_IDX                                      = 257,
    SBK_QSTATUSTIPEVENT_IDX                                  = 259,
    SBK_QSTYLEHINTS_IDX                                      = 260,
    SBK_QSURFACE_SURFACECLASS_IDX                            = 262,
    SBK_QSURFACE_SURFACETYPE_IDX                             = 263,
    SBK_QSURFACE_IDX                                         = 261,
    SBK_QSURFACEFORMAT_FORMATOPTION_IDX                      = 266,
    SBK_QFLAGS_QSURFACEFORMAT_FORMATOPTION_IDX               = 85,
    SBK_QSURFACEFORMAT_SWAPBEHAVIOR_IDX                      = 269,
    SBK_QSURFACEFORMAT_RENDERABLETYPE_IDX                    = 268,
    SBK_QSURFACEFORMAT_OPENGLCONTEXTPROFILE_IDX              = 267,
    SBK_QSURFACEFORMAT_COLORSPACE_IDX                        = 265,
    SBK_QSURFACEFORMAT_IDX                                   = 264,
    SBK_QSYNTAXHIGHLIGHTER_IDX                               = 270,
    SBK_QTABLETEVENT_IDX                                     = 271,
    SBK_QTEXTBLOCK_IDX                                       = 272,
    SBK_QTEXTBLOCK_ITERATOR_IDX                              = 273,
    SBK_QTEXTBLOCKFORMAT_LINEHEIGHTTYPES_IDX                 = 353,
    SBK_QTEXTBLOCKFORMAT_MARKERTYPE_IDX                      = 275,
    SBK_QTEXTBLOCKFORMAT_IDX                                 = 274,
    SBK_QTEXTBLOCKGROUP_IDX                                  = 276,
    SBK_QTEXTBLOCKUSERDATA_IDX                               = 277,
    SBK_QTEXTCHARFORMAT_VERTICALALIGNMENT_IDX                = 281,
    SBK_QTEXTCHARFORMAT_UNDERLINESTYLE_IDX                   = 280,
    SBK_QTEXTCHARFORMAT_FONTPROPERTIESINHERITANCEBEHAVIOR_IDX = 279,
    SBK_QTEXTCHARFORMAT_IDX                                  = 278,
    SBK_QTEXTCURSOR_MOVEMODE_IDX                             = 283,
    SBK_QTEXTCURSOR_MOVEOPERATION_IDX                        = 284,
    SBK_QTEXTCURSOR_SELECTIONTYPE_IDX                        = 285,
    SBK_QTEXTCURSOR_IDX                                      = 282,
    SBK_QTEXTDOCUMENT_METAINFORMATION_IDX                    = 289,
    SBK_QTEXTDOCUMENT_MARKDOWNFEATURE_IDX                    = 288,
    SBK_QFLAGS_QTEXTDOCUMENT_MARKDOWNFEATURE_IDX             = 87,
    SBK_QTEXTDOCUMENT_FINDFLAG_IDX                           = 287,
    SBK_QFLAGS_QTEXTDOCUMENT_FINDFLAG_IDX                    = 86,
    SBK_QTEXTDOCUMENT_RESOURCETYPE_IDX                       = 290,
    SBK_QTEXTDOCUMENT_STACKS_IDX                             = 291,
    SBK_QTEXTDOCUMENT_IDX                                    = 286,
    SBK_QTEXTDOCUMENTFRAGMENT_IDX                            = 292,
    SBK_QTEXTDOCUMENTWRITER_IDX                              = 293,
    SBK_QTEXTFORMAT_FORMATTYPE_IDX                           = 295,
    SBK_QTEXTFORMAT_PROPERTY_IDX                             = 298,
    SBK_QTEXTFORMAT_OBJECTTYPES_IDX                          = 296,
    SBK_QTEXTFORMAT_PAGEBREAKFLAG_IDX                        = 297,
    SBK_QFLAGS_QTEXTFORMAT_PAGEBREAKFLAG_IDX                 = 88,
    SBK_QTEXTFORMAT_IDX                                      = 294,
    SBK_QTEXTFRAGMENT_IDX                                    = 299,
    SBK_QTEXTFRAME_IDX                                       = 300,
    SBK_QTEXTFRAME_ITERATOR_IDX                              = 301,
    SBK_QTEXTFRAMEFORMAT_POSITION_IDX                        = 304,
    SBK_QTEXTFRAMEFORMAT_BORDERSTYLE_IDX                     = 303,
    SBK_QTEXTFRAMEFORMAT_IDX                                 = 302,
    SBK_QTEXTIMAGEFORMAT_IDX                                 = 305,
    SBK_QTEXTINLINEOBJECT_IDX                                = 306,
    SBK_QTEXTITEM_RENDERFLAG_IDX                             = 308,
    SBK_QFLAGS_QTEXTITEM_RENDERFLAG_IDX                      = 89,
    SBK_QTEXTITEM_IDX                                        = 307,
    SBK_QTEXTLAYOUT_CURSORMODE_IDX                           = 310,
    SBK_QTEXTLAYOUT_IDX                                      = 309,
    SBK_QTEXTLAYOUT_FORMATRANGE_IDX                          = 311,
    SBK_QTEXTLENGTH_TYPE_IDX                                 = 313,
    SBK_QTEXTLENGTH_IDX                                      = 312,
    SBK_QTEXTLINE_EDGE_IDX                                   = 316,
    SBK_QTEXTLINE_CURSORPOSITION_IDX                         = 315,
    SBK_QTEXTLINE_IDX                                        = 314,
    SBK_QTEXTLIST_IDX                                        = 317,
    SBK_QTEXTLISTFORMAT_STYLE_IDX                            = 319,
    SBK_QTEXTLISTFORMAT_IDX                                  = 318,
    SBK_QTEXTOBJECT_IDX                                      = 320,
    SBK_QTEXTOBJECTINTERFACE_IDX                             = 321,
    SBK_QTEXTOPTION_TABTYPE_IDX                              = 325,
    SBK_QTEXTOPTION_WRAPMODE_IDX                             = 326,
    SBK_QTEXTOPTION_FLAG_IDX                                 = 323,
    SBK_QFLAGS_QTEXTOPTION_FLAG_IDX                          = 90,
    SBK_QTEXTOPTION_IDX                                      = 322,
    SBK_QTEXTOPTION_TAB_IDX                                  = 324,
    SBK_QTEXTTABLE_IDX                                       = 327,
    SBK_QTEXTTABLECELL_IDX                                   = 328,
    SBK_QTEXTTABLECELLFORMAT_IDX                             = 329,
    SBK_QTEXTTABLEFORMAT_IDX                                 = 330,
    SBK_QTOOLBARCHANGEEVENT_IDX                              = 331,
    SBK_QTOUCHEVENT_IDX                                      = 332,
    SBK_QTRANSFORM_TRANSFORMATIONTYPE_IDX                    = 334,
    SBK_QTRANSFORM_IDX                                       = 333,
    SBK_QUNDOCOMMAND_IDX                                     = 335,
    SBK_QUNDOGROUP_IDX                                       = 336,
    SBK_QUNDOSTACK_IDX                                       = 337,
    SBK_QVALIDATOR_STATE_IDX                                 = 339,
    SBK_QVALIDATOR_IDX                                       = 338,
    SBK_QVECTOR2D_IDX                                        = 340,
    SBK_QVECTOR3D_IDX                                        = 341,
    SBK_QVECTOR4D_IDX                                        = 342,
    SBK_QWHATSTHISCLICKEDEVENT_IDX                           = 343,
    SBK_QWHEELEVENT_IDX                                      = 344,
    SBK_QWINDOW_VISIBILITY_IDX                               = 347,
    SBK_QWINDOW_ANCESTORMODE_IDX                             = 346,
    SBK_QWINDOW_IDX                                          = 345,
    SBK_QWINDOWSTATECHANGEEVENT_IDX                          = 348,
    SBK_QtGuiQT_IDX                                          = 349,
    SBK_QTGUIHELPER_QOVERRIDECURSORGUARD_IDX                 = 351,
    SBK_QtGui_IDX_COUNT                                      = 354
};
...
enum : int {
    ...
    SBK_HRGN_IDX                                             = 2,
    SBK_WID_IDX                                              = 3,
    SBK_QTGUI_QLIST_INT_IDX                                  = 4, // QList<int >
    SBK_QTGUI_QLIST_QVECTOR2D_IDX                            = 5, // QList<QVector2D >
    SBK_QTGUI_QLIST_QVECTOR3D_IDX                            = 6, // QList<QVector3D >
    SBK_QTGUI_QLIST_QVECTOR4D_IDX                            = 7, // QList<QVector4D >
    SBK_QTGUI_QLIST_QREAL_IDX                                = 8, // QList<qreal >
    SBK_QTGUI_QLIST_QTEXTOPTION_TAB_IDX                      = 9, // QList<QTextOption::Tab >
    SBK_QTGUI_QLIST_QGLYPHRUN_IDX                            = 10, // QList<QGlyphRun >
    SBK_QTGUI_QLIST_QTEXTLENGTH_IDX                          = 11, // QList<QTextLength >
    SBK_QTGUI_QMAP_INT_QVARIANT_IDX                          = 12, // QMap<int,QVariant >
    SBK_QTGUI_QLIST_QTEXTLAYOUT_FORMATRANGE_IDX              = 13, // QList<QTextLayout::FormatRange >
    SBK_QTGUI_QPAIR_INT_INT_IDX                              = 14, // QPair<int,int >
    SBK_QTGUI_QLIST_QSTANDARDITEMPTR_IDX                     = 15, // QList<QStandardItem* >
    SBK_QTGUI_QLIST_QPOINTF_IDX                              = 16, // QList<QPointF >
    SBK_QTGUI_QLIST_QUINT32_IDX                              = 17, // QList<quint32 >
    SBK_QTGUI_QLIST_QFONTDATABASE_WRITINGSYSTEM_IDX          = 18, // QList<QFontDatabase::WritingSystem >
    SBK_QTGUI_QLIST_QPOINT_IDX                               = 19, // QList<QPoint >
    SBK_QTGUI_QLIST_QPOLYGONF_IDX                            = 20, // QList<QPolygonF >
    SBK_QTGUI_QLIST_QPAGERANGES_RANGE_IDX                    = 21, // QList<QPageRanges::Range >
    SBK_QTGUI_QLIST_FLOAT_IDX                                = 22, // QList<float >
    SBK_QTGUI_QLIST_QSIZE_IDX                                = 23, // QList<QSize >
    SBK_QTGUI_STD_PAIR_QREAL_QCOLOR_IDX                      = 24, // std::pair<qreal,QColor >
    SBK_QTGUI_QLIST_STD_PAIR_QREAL_QCOLOR_IDX                = 25, // QList<std::pair< qreal,QColor > >
    SBK_QTGUI_QLIST_UINT16_T_IDX                             = 26, // QList<uint16_t >
    SBK_QTGUI_QLIST_QACCESSIBLEINTERFACEPTR_IDX              = 27, // QList<QAccessibleInterface* >
    SBK_QTGUI_QPAIR_QACCESSIBLEINTERFACEPTR_QFLAGS_QACCESSIBLE_RELATIONFLAG_IDX = 28, // QPair<QAccessibleInterface*,QFlags<QAccessible::RelationFlag> >
    SBK_QTGUI_QLIST_QPAIR_QACCESSIBLEINTERFACEPTR_QFLAGS_QACCESSIBLE_RELATIONFLAG_IDX = 29, // QList<QPair< QAccessibleInterface*,QFlags<QAccessible::RelationFlag> > >
    SBK_QTGUI_QLIST_UNSIGNEDINT_IDX                          = 30, // QList<unsigned int >
    SBK_QTGUI_QLIST_QLINE_IDX                                = 31, // QList<QLine >
    SBK_QTGUI_QLIST_QLINEF_IDX                               = 32, // QList<QLineF >
    SBK_QTGUI_QLIST_QRECT_IDX                                = 33, // QList<QRect >
    SBK_QTGUI_QLIST_QRECTF_IDX                               = 34, // QList<QRectF >
    SBK_QTGUI_QLIST_QKEYSEQUENCE_IDX                         = 35, // QList<QKeySequence >
    SBK_QTGUI_QLIST_QOBJECTPTR_IDX                           = 36, // QList<QObject* >
    SBK_QTGUI_QLIST_QBYTEARRAY_IDX                           = 37, // QList<QByteArray >
    SBK_QTGUI_QLIST_QUNDOSTACKPTR_IDX                        = 38, // QList<QUndoStack* >
    SBK_QTGUI_QLIST_QTEXTFRAMEPTR_IDX                        = 39, // QList<QTextFrame* >
    SBK_QTGUI_QLIST_QTEXTBLOCK_IDX                           = 40, // QList<QTextBlock >
    SBK_QTGUI_QLIST_QTEXTFORMAT_IDX                          = 41, // QList<QTextFormat >
    SBK_QTGUI_QLIST_QSCREENPTR_IDX                           = 42, // QList<QScreen* >
    SBK_QTGUI_QLIST_QOPENGLCONTEXTPTR_IDX                    = 43, // QList<QOpenGLContext* >
    SBK_QTGUI_QSET_QBYTEARRAY_IDX                            = 44, // QSet<QByteArray >
    SBK_QTGUI_QLIST_CONSTQINPUTDEVICEPTR_IDX                 = 45, // QList<const QInputDevice* >
    SBK_QTGUI_QLIST_QACTIONPTR_IDX                           = 46, // QList<QAction* >
    SBK_QTGUI_QLIST_QINPUTMETHODEVENT_ATTRIBUTE_IDX          = 47, // QList<QInputMethodEvent::Attribute >
    SBK_QTGUI_QLIST_QEVENTPOINT_IDX                          = 48, // QList<QEventPoint >
    SBK_QTGUI_QLIST_QWINDOWPTR_IDX                           = 49, // QList<QWindow* >
    SBK_QTGUI_QLIST_QMODELINDEX_IDX                          = 50, // QList<QModelIndex >
    SBK_QTGUI_QLIST_QPERSISTENTMODELINDEX_IDX                = 51, // QList<QPersistentModelIndex >
    SBK_QTGUI_QHASH_INT_QBYTEARRAY_IDX                       = 52, // QHash<int,QByteArray >
