...
// Type indices
enum : int {
    SBK_Qt3DCoreQT3DCORE_IDX                                 = 0,
    SBK_QT3DCORE_QABSTRACTASPECT_IDX                         = 1,
    SBK_QT3DCORE_QABSTRACTFUNCTOR_IDX                        = 2,
    SBK_QT3DCORE_QABSTRACTSKELETON_IDX                       = 3,
    SBK_QT3DCORE_QARMATURE_IDX                               = 4,
    SBK_QT3DCORE_QASPECTENGINE_RUNMODE_IDX                   = 6,
    SBK_QT3DCORE_QASPECTENGINE_IDX                           = 5,
    SBK_QT3DCORE_QASPECTJOB_IDX                              = 7,
    SBK_QT3DCORE_QATTRIBUTE_ATTRIBUTETYPE_IDX                = 9,
    SBK_QT3DCORE_QATTRIBUTE_VERTEXBASETYPE_IDX               = 10,
    SBK_QT3DCORE_QATTRIBUTE_IDX                              = 8,
    SBK_QT3DCORE_QBACKENDNODE_MODE_IDX                       = 12,
    SBK_QT3DCORE_QBACKENDNODE_IDX                            = 11,
    SBK_QT3DCORE_QBACKENDNODEMAPPER_IDX                      = 13,
    SBK_QT3DCORE_QBOUNDINGVOLUME_IDX                         = 14,
    SBK_QT3DCORE_QBUFFER_USAGETYPE_IDX                       = 17,
    SBK_QT3DCORE_QBUFFER_ACCESSTYPE_IDX                      = 16,
    SBK_QT3DCORE_QBUFFER_IDX                                 = 15,
    SBK_QT3DCORE_QCOMPONENT_IDX                              = 18,
    SBK_QT3DCORE_QCORESETTINGS_IDX                           = 19,
    SBK_QT3DCORE_QENTITY_IDX                                 = 20,
    SBK_QT3DCORE_QGEOMETRY_IDX                               = 21,
    SBK_QT3DCORE_QGEOMETRYVIEW_PRIMITIVETYPE_IDX             = 23,
    SBK_QT3DCORE_QGEOMETRYVIEW_IDX                           = 22,
    SBK_QT3DCORE_QJOINT_IDX                                  = 24,
    SBK_QT3DCORE_QNODE_IDX                                   = 25,
    SBK_QT3DCORE_QNODEID_IDX                                 = 26,
    SBK_QT3DCORE_QNODEIDTYPEPAIR_IDX                         = 27,
    SBK_QT3DCORE_QSKELETON_IDX                               = 28,
    SBK_QT3DCORE_QSKELETONLOADER_STATUS_IDX                  = 30,
    SBK_QT3DCORE_QSKELETONLOADER_IDX                         = 29,
    SBK_QT3DCORE_QTRANSFORM_IDX                              = 31,
    SBK_Qt3DCore_IDX_COUNT                                   = 32
};
...
enum : int {
    ...
    SBK_QT3DCORE_QLIST_QT3DCORE_QABSTRACTASPECTPTR_IDX       = 1, // QList<Qt3DCore::QAbstractAspect* >
    SBK_QT3DCORE_QLIST_QOBJECTPTR_IDX                        = 2, // QList<QObject* >
    SBK_QT3DCORE_QLIST_QBYTEARRAY_IDX                        = 3, // QList<QByteArray >
    SBK_QT3DCORE_QLIST_QT3DCORE_QNODEPTR_IDX                 = 4, // QList<Qt3DCore::QNode* >
    SBK_QT3DCORE_QLIST_QT3DCORE_QNODEID_IDX                  = 5, // QList<Qt3DCore::QNodeId >
    SBK_QT3DCORE_QLIST_QT3DCORE_QJOINTPTR_IDX                = 6, // QList<Qt3DCore::QJoint* >
    SBK_QT3DCORE_QLIST_QT3DCORE_QCOMPONENTPTR_IDX            = 7, // QList<Qt3DCore::QComponent* >
    SBK_QT3DCORE_QLIST_QT3DCORE_QATTRIBUTEPTR_IDX            = 8, // QList<Qt3DCore::QAttribute* >
    SBK_QT3DCORE_QLIST_QT3DCORE_QENTITYPTR_IDX               = 9, // QList<Qt3DCore::QEntity* >
    SBK_QT3DCORE_QLIST_QVARIANT_IDX                          = 10, // QList<QVariant >
    SBK_QT3DCORE_QLIST_QSTRING_IDX                           = 11, // QList<QString >
    SBK_QT3DCORE_QMAP_QSTRING_QVARIANT_IDX                   = 12, // QMap<QString,QVariant >
    SBK_Qt3DCore_CONVERTERS_IDX_COUNT                        = 13
};
