...
enum : int {
    ...
    SBK_QCOREAPPLICATION_APPLICATIONFLAGS_IDX                = 431,
    ...
    SBK_QIODEVICE_IDX                                        = 151,
    SBK_QIODEVICEBASE_OPENMODEFLAG_IDX                       = 153,
    SBK_QFLAGS_QIODEVICEBASE_OPENMODEFLAG_IDX                = 105,
    SBK_QIODEVICEBASE_IDX                                    = 152,
    SBK_QIDENTITYPROXYMODEL_IDX                              = 154,
    SBK_QITEMSELECTION_IDX                                   = 155,
    SBK_QITEMSELECTIONMODEL_SELECTIONFLAG_IDX                = 157,
    SBK_QFLAGS_QITEMSELECTIONMODEL_SELECTIONFLAG_IDX         = 106,
    SBK_QITEMSELECTIONMODEL_IDX                              = 156,
    SBK_QITEMSELECTIONRANGE_IDX                              = 158,
    SBK_QJSONARRAY_IDX                                       = 159,
    SBK_QJSONDOCUMENT_JSONFORMAT_IDX                         = 161,
    SBK_QJSONDOCUMENT_IDX                                    = 160,
    SBK_QJSONPARSEERROR_PARSEERROR_IDX                       = 163,
    SBK_QJSONPARSEERROR_IDX                                  = 162,
    SBK_QJSONVALUE_TYPE_IDX                                  = 165,
    SBK_QJSONVALUE_IDX                                       = 164,
    SBK_QKEYCOMBINATION_IDX                                  = 166,
    SBK_QLIBRARY_LOADHINT_IDX                                = 168,
    SBK_QFLAGS_QLIBRARY_LOADHINT_IDX                         = 107,
    SBK_QLIBRARY_IDX                                         = 167,
    SBK_QLIBRARYINFO_LIBRARYPATH_IDX                         = 170,
    SBK_QLIBRARYINFO_IDX                                     = 169,
    SBK_QLINE_IDX                                            = 171,
    SBK_QLINEF_INTERSECTIONTYPE_IDX                          = 173,
    SBK_QLINEF_IDX                                           = 172,
    SBK_QLOCALE_LANGUAGE_IDX                                 = 179,
    SBK_QLOCALE_SCRIPT_IDX                                   = 434,
    SBK_QLOCALE_COUNTRY_IDX                                  = 175,
    SBK_QLOCALE_MEASUREMENTSYSTEM_IDX                        = 181,
    SBK_QLOCALE_FORMATTYPE_IDX                               = 178,
    SBK_QLOCALE_NUMBEROPTION_IDX                             = 182,
    SBK_QFLAGS_QLOCALE_NUMBEROPTION_IDX                      = 110,
    SBK_QLOCALE_FLOATINGPOINTPRECISIONOPTION_IDX             = 177,
    SBK_QLOCALE_CURRENCYSYMBOLFORMAT_IDX                     = 432,
    SBK_QLOCALE_DATASIZEFORMAT_IDX                           = 176,
    SBK_QFLAGS_QLOCALE_DATASIZEFORMAT_IDX                    = 108,
    SBK_QLOCALE_LANGUAGECODETYPE_IDX                         = 180,
    SBK_QFLAGS_QLOCALE_LANGUAGECODETYPE_IDX                  = 109,
    SBK_QLOCALE_QUOTATIONSTYLE_IDX                           = 433,
    SBK_QLOCALE_IDX                                          = 174,
    SBK_QLOCKFILE_LOCKERROR_IDX                              = 184,
    SBK_QLOCKFILE_IDX                                        = 183,
    SBK_QLOGGINGCATEGORY_IDX                                 = 185,
    SBK_QMARGINS_IDX                                         = 186,
    SBK_QMARGINSF_IDX                                        = 187,
    SBK_QMESSAGEAUTHENTICATIONCODE_IDX                       = 188,
    SBK_QMESSAGELOGCONTEXT_IDX                               = 189,
    SBK_QMETACLASSINFO_IDX                                   = 190,
    SBK_QMETAENUM_IDX                                        = 191,
    SBK_QMETAMETHOD_ACCESS_IDX                               = 193,
    SBK_QMETAMETHOD_METHODTYPE_IDX                           = 194,
    SBK_QMETAMETHOD_IDX                                      = 192,
    SBK_QMETAOBJECT_CALL_IDX                                 = 196,
    SBK_QMETAOBJECT_IDX                                      = 195,
    SBK_QMETAOBJECT_CONNECTION_IDX                           = 197,
    SBK_QMETAPROPERTY_IDX                                    = 198,
    SBK_QMETATYPE_TYPE_IDX                                   = 200,
    SBK_QMETATYPE_TYPEFLAG_IDX                               = 201,
    SBK_QFLAGS_QMETATYPE_TYPEFLAG_IDX                        = 111,
    SBK_QMETATYPE_IDX                                        = 199,
    SBK_QMIMEDATA_IDX                                        = 202,
    SBK_QMIMEDATABASE_MATCHMODE_IDX                          = 204,
    SBK_QMIMEDATABASE_IDX                                    = 203,
    SBK_QMIMETYPE_IDX                                        = 205,
    SBK_QMODELINDEX_IDX                                      = 206,
    SBK_QMODELROLEDATA_IDX                                   = 207,
    SBK_QMUTEX_IDX                                           = 208,
    SBK_QOBJECT_IDX                                          = 209,
    SBK_QOPERATINGSYSTEMVERSION_OSTYPE_IDX                   = 211,
    SBK_QOPERATINGSYSTEMVERSION_IDX                          = 210,
    SBK_QOPERATINGSYSTEMVERSIONBASE_OSTYPE_IDX               = 213,
    SBK_QOPERATINGSYSTEMVERSIONBASE_IDX                      = 212,
    SBK_QPARALLELANIMATIONGROUP_IDX                          = 214,
    SBK_QPAUSEANIMATION_IDX                                  = 215,
    SBK_QPERSISTENTMODELINDEX_IDX                            = 216,
    SBK_QPLUGINLOADER_IDX                                    = 217,
    SBK_QPOINT_IDX                                           = 218,
    SBK_QPOINTF_IDX                                          = 219,
    SBK_QPROCESS_PROCESSERROR_IDX                            = 225,
    SBK_QPROCESS_PROCESSSTATE_IDX                            = 226,
    SBK_QPROCESS_PROCESSCHANNEL_IDX                          = 223,
    SBK_QPROCESS_PROCESSCHANNELMODE_IDX                      = 224,
    SBK_QPROCESS_INPUTCHANNELMODE_IDX                        = 222,
    SBK_QPROCESS_EXITSTATUS_IDX                              = 221,
    SBK_QPROCESS_IDX                                         = 220,
    SBK_QPROCESSENVIRONMENT_INITIALIZATION_IDX               = 228,
    SBK_QPROCESSENVIRONMENT_IDX                              = 227,
    SBK_QPROPERTYANIMATION_IDX                               = 229,
    SBK_QRANDOMGENERATOR_IDX                                 = 230,
    SBK_QRANDOMGENERATOR64_IDX                               = 231,
    SBK_QREADLOCKER_IDX                                      = 232,
    SBK_QREADWRITELOCK_RECURSIONMODE_IDX                     = 234,
    SBK_QREADWRITELOCK_IDX                                   = 233,
    SBK_QRECT_IDX                                            = 235,
    SBK_QRECTF_IDX                                           = 236,
    SBK_QRECURSIVEMUTEX_IDX                                  = 237,
    SBK_QREGULAREXPRESSION_PATTERNOPTION_IDX                 = 241,
    SBK_QFLAGS_QREGULAREXPRESSION_PATTERNOPTION_IDX          = 113,
    SBK_QREGULAREXPRESSION_MATCHTYPE_IDX                     = 240,
    SBK_QREGULAREXPRESSION_MATCHOPTION_IDX                   = 239,
    SBK_QFLAGS_QREGULAREXPRESSION_MATCHOPTION_IDX            = 112,
    SBK_QREGULAREXPRESSION_WILDCARDCONVERSIONOPTION_IDX      = 242,
    SBK_QFLAGS_QREGULAREXPRESSION_WILDCARDCONVERSIONOPTION_IDX = 114,
    SBK_QREGULAREXPRESSION_IDX                               = 238,
    SBK_QREGULAREXPRESSIONMATCH_IDX                          = 243,
    SBK_QREGULAREXPRESSIONMATCHITERATOR_IDX                  = 244,
    SBK_QRESOURCE_COMPRESSION_IDX                            = 246,
    SBK_QRESOURCE_IDX                                        = 245,
    SBK_QRUNNABLE_IDX                                        = 247,
    SBK_QSAVEFILE_IDX                                        = 248,
    SBK_QSEMAPHORE_IDX                                       = 249,
    SBK_QSEMAPHORERELEASER_IDX                               = 250,
    SBK_QSEQUENTIALANIMATIONGROUP_IDX                        = 251,
    SBK_QSETTINGS_STATUS_IDX                                 = 255,
    SBK_QSETTINGS_FORMAT_IDX                                 = 253,
    SBK_QSETTINGS_SCOPE_IDX                                  = 254,
    SBK_QSETTINGS_IDX                                        = 252,
    SBK_QSHAREDMEMORY_ACCESSMODE_IDX                         = 257,
    SBK_QSHAREDMEMORY_SHAREDMEMORYERROR_IDX                  = 258,
    SBK_QSHAREDMEMORY_IDX                                    = 256,
    SBK_QSIGNALBLOCKER_IDX                                   = 259,
    SBK_QSIGNALMAPPER_IDX                                    = 260,
    SBK_QSIZE_IDX                                            = 261,
    SBK_QSIZEF_IDX                                           = 262,
    SBK_QSOCKETDESCRIPTOR_IDX                                = 263,
    SBK_QSOCKETNOTIFIER_TYPE_IDX                             = 265,
    SBK_QSOCKETNOTIFIER_IDX                                  = 264,
    SBK_QSORTFILTERPROXYMODEL_IDX                            = 266,
    SBK_QSTANDARDPATHS_STANDARDLOCATION_IDX                  = 269,
    SBK_QSTANDARDPATHS_LOCATEOPTION_IDX                      = 268,
    SBK_QFLAGS_QSTANDARDPATHS_LOCATEOPTION_IDX               = 115,
    SBK_QSTANDARDPATHS_IDX                                   = 267,
    SBK_QSTORAGEINFO_IDX                                     = 270,
    SBK_QSTRINGCONVERTER_ENCODING_IDX                        = 272,
    SBK_QSTRINGCONVERTER_IDX                                 = 271,
    SBK_QSTRINGCONVERTERBASE_FLAG_IDX                        = 274,
    SBK_QFLAGS_QSTRINGCONVERTERBASE_FLAG_IDX                 = 116,
    SBK_QSTRINGCONVERTERBASE_IDX                             = 273,
    SBK_QSTRINGCONVERTERBASE_STATE_IDX                       = 275,
    SBK_QSTRINGDECODER_IDX                                   = 276,
    SBK_QSTRINGENCODER_IDX                                   = 277,
    SBK_QSTRINGLISTMODEL_IDX                                 = 278,
    SBK_QSYSINFO_SIZES_IDX                                   = 281,
    SBK_QSYSINFO_ENDIAN_IDX                                  = 280,
    SBK_QSYSINFO_IDX                                         = 279,
    SBK_QSYSTEMSEMAPHORE_ACCESSMODE_IDX                      = 283,
    SBK_QSYSTEMSEMAPHORE_SYSTEMSEMAPHOREERROR_IDX            = 284,
    SBK_QSYSTEMSEMAPHORE_IDX                                 = 282,
    SBK_QTEMPORARYDIR_IDX                                    = 285,
    SBK_QTEMPORARYFILE_IDX                                   = 286,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYTYPE_IDX                 = 289,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX               = 288,
    SBK_QFLAGS_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX        = 117,
    SBK_QTEXTBOUNDARYFINDER_IDX                              = 287,
    SBK_QTEXTSTREAM_REALNUMBERNOTATION_IDX                   = 293,
    SBK_QTEXTSTREAM_FIELDALIGNMENT_IDX                       = 291,
    SBK_QTEXTSTREAM_STATUS_IDX                               = 294,
    SBK_QTEXTSTREAM_NUMBERFLAG_IDX                           = 292,
    SBK_QFLAGS_QTEXTSTREAM_NUMBERFLAG_IDX                    = 118,
    SBK_QTEXTSTREAM_IDX                                      = 290,
    SBK_QTEXTSTREAMMANIPULATOR_IDX                           = 295,
    SBK_QTHREAD_PRIORITY_IDX                                 = 297,
    SBK_QTHREAD_IDX                                          = 296,
    SBK_QTHREADPOOL_IDX                                      = 298,
    SBK_QTIME_IDX                                            = 299,
    SBK_QTIMELINE_STATE_IDX                                  = 302,
    SBK_QTIMELINE_DIRECTION_IDX                              = 301,
    SBK_QTIMELINE_IDX                                        = 300,
    SBK_QTIMEZONE_TIMETYPE_IDX                               = 306,
    SBK_QTIMEZONE_NAMETYPE_IDX                               = 304,
    SBK_QTIMEZONE_IDX                                        = 303,
    SBK_QTIMEZONE_OFFSETDATA_IDX                             = 305,
    SBK_QTIMER_IDX                                           = 307,
    SBK_QTIMEREVENT_IDX                                      = 308,
    SBK_QTRANSLATOR_IDX                                      = 309,
    SBK_QTRANSPOSEPROXYMODEL_IDX                             = 310,
    SBK_QURL_PARSINGMODE_IDX                                 = 314,
    SBK_QURL_URLFORMATTINGOPTION_IDX                         = 315,
    SBK_QURL_COMPONENTFORMATTINGOPTION_IDX                   = 313,
    SBK_QFLAGS_QURL_COMPONENTFORMATTINGOPTION_IDX            = 120,
    SBK_QURL_USERINPUTRESOLUTIONOPTION_IDX                   = 316,
    SBK_QFLAGS_QURL_USERINPUTRESOLUTIONOPTION_IDX            = 122,
    SBK_QURL_ACEPROCESSINGOPTION_IDX                         = 312,
    SBK_QFLAGS_QURL_ACEPROCESSINGOPTION_IDX                  = 119,
    SBK_QURL_IDX                                             = 311,
    SBK_QURLQUERY_IDX                                        = 317,
    SBK_QUUID_VARIANT_IDX                                    = 320,
    SBK_QUUID_VERSION_IDX                                    = 321,
    SBK_QUUID_STRINGFORMAT_IDX                               = 319,
    SBK_QUUID_IDX                                            = 318,
    SBK_QVARIANTANIMATION_IDX                                = 322,
    SBK_QVERSIONNUMBER_IDX                                   = 323,
    SBK_QWAITCONDITION_IDX                                   = 324,
    SBK_QWINEVENTNOTIFIER_IDX                                = 325,
    SBK_QWRITELOCKER_IDX                                     = 326,
    SBK_QXMLSTREAMATTRIBUTE_IDX                              = 327,
    SBK_QXMLSTREAMATTRIBUTES_IDX                             = 328,
    SBK_QXMLSTREAMENTITYDECLARATION_IDX                      = 329,
    SBK_QXMLSTREAMENTITYRESOLVER_IDX                         = 330,
    SBK_QXMLSTREAMNAMESPACEDECLARATION_IDX                   = 331,
    SBK_QXMLSTREAMNOTATIONDECLARATION_IDX                    = 332,
    SBK_QXMLSTREAMREADER_TOKENTYPE_IDX                       = 336,
    SBK_QXMLSTREAMREADER_READELEMENTTEXTBEHAVIOUR_IDX        = 335,
    SBK_QXMLSTREAMREADER_ERROR_IDX                           = 334,
    SBK_QXMLSTREAMREADER_IDX                                 = 333,
    SBK_QXMLSTREAMWRITER_IDX                                 = 337,
    SBK_QT_GLOBALCOLOR_IDX                                   = 372,
    SBK_QT_MOUSEBUTTON_IDX                                   = 388,
    SBK_QFLAGS_QT_MOUSEBUTTON_IDX                            = 136,
    SBK_QT_ORIENTATION_IDX                                   = 393,
    SBK_QFLAGS_QT_ORIENTATION_IDX                            = 138,
    SBK_QT_FOCUSPOLICY_IDX                                   = 367,
    SBK_QT_TABFOCUSBEHAVIOR_IDX                              = 406,
    SBK_QT_SORTORDER_IDX                                     = 404,
    SBK_QT_SPLITBEHAVIORFLAGS_IDX                            = 405,
    SBK_QFLAGS_QT_SPLITBEHAVIORFLAGS_IDX                     = 140,
    SBK_QT_TILERULE_IDX                                      = 411,
    SBK_QT_ALIGNMENTFLAG_IDX                                 = 339,
    SBK_QFLAGS_QT_ALIGNMENTFLAG_IDX                          = 123,
    SBK_QT_TEXTFLAG_IDX                                      = 408,
    SBK_QT_TEXTELIDEMODE_IDX                                 = 407,
    SBK_QT_WHITESPACEMODE_IDX                                = 420,
    SBK_QT_HITTESTACCURACY_IDX                               = 374,
    SBK_QT_WINDOWTYPE_IDX                                    = 425,
    SBK_QFLAGS_QT_WINDOWTYPE_IDX                             = 145,
    SBK_QT_WINDOWSTATE_IDX                                   = 424,
    SBK_QFLAGS_QT_WINDOWSTATE_IDX                            = 144,
    SBK_QT_APPLICATIONSTATE_IDX                              = 342,
    SBK_QFLAGS_QT_APPLICATIONSTATE_IDX                       = 124,
    SBK_QT_SCREENORIENTATION_IDX                             = 398,
    SBK_QFLAGS_QT_SCREENORIENTATION_IDX                      = 139,
    SBK_QT_WIDGETATTRIBUTE_IDX                               = 421,
    SBK_QT_APPLICATIONATTRIBUTE_IDX                          = 341,
    SBK_QT_IMAGECONVERSIONFLAG_IDX                           = 375,
    SBK_QFLAGS_QT_IMAGECONVERSIONFLAG_IDX                    = 130,
    SBK_QT_BGMODE_IDX                                        = 346,
    SBK_QT_KEY_IDX                                           = 382,
    SBK_QT_KEYBOARDMODIFIER_IDX                              = 383,
    SBK_QFLAGS_QT_KEYBOARDMODIFIER_IDX                       = 134,
    SBK_QT_MODIFIER_IDX                                      = 387,
    SBK_QT_ARROWTYPE_IDX                                     = 343,
    SBK_QT_PENSTYLE_IDX                                      = 396,
    SBK_QT_PENCAPSTYLE_IDX                                   = 394,
    SBK_QT_PENJOINSTYLE_IDX                                  = 395,
    SBK_QT_BRUSHSTYLE_IDX                                    = 347,
    SBK_QT_SIZEMODE_IDX                                      = 403,
    SBK_QT_UIEFFECT_IDX                                      = 419,
    SBK_QT_CURSORSHAPE_IDX                                   = 356,
    SBK_QT_TEXTFORMAT_IDX                                    = 409,
    SBK_QT_ASPECTRATIOMODE_IDX                               = 344,
    SBK_QT_DOCKWIDGETAREA_IDX                                = 359,
    SBK_QFLAGS_QT_DOCKWIDGETAREA_IDX                         = 125,
    SBK_QT_DOCKWIDGETAREASIZES_IDX                           = 360,
    SBK_QT_TOOLBARAREA_IDX                                   = 414,
    SBK_QFLAGS_QT_TOOLBARAREA_IDX                            = 142,
    SBK_QT_TOOLBARAREASIZES_IDX                              = 415,
    SBK_QT_DATEFORMAT_IDX                                    = 357,
    SBK_QT_TIMESPEC_IDX                                      = 412,
    SBK_QT_DAYOFWEEK_IDX                                     = 358,
    SBK_QT_SCROLLBARPOLICY_IDX                               = 399,
    SBK_QT_CASESENSITIVITY_IDX                               = 348,
    SBK_QT_CORNER_IDX                                        = 355,
    SBK_QT_EDGE_IDX                                          = 362,
    SBK_QFLAGS_QT_EDGE_IDX                                   = 127,
    SBK_QT_CONNECTIONTYPE_IDX                                = 352,
    SBK_QT_SHORTCUTCONTEXT_IDX                               = 401,
    SBK_QT_FILLRULE_IDX                                      = 365,
    SBK_QT_MASKMODE_IDX                                      = 385,
    SBK_QT_CLIPOPERATION_IDX                                 = 351,
    SBK_QT_ITEMSELECTIONMODE_IDX                             = 380,
    SBK_QT_ITEMSELECTIONOPERATION_IDX                        = 381,
    SBK_QT_TRANSFORMATIONMODE_IDX                            = 418,
    SBK_QT_AXIS_IDX                                          = 345,
    SBK_QT_FOCUSREASON_IDX                                   = 368,
    SBK_QT_CONTEXTMENUPOLICY_IDX                             = 353,
    SBK_QT_INPUTMETHODQUERY_IDX                              = 377,
    SBK_QFLAGS_QT_INPUTMETHODQUERY_IDX                       = 132,
    SBK_QT_INPUTMETHODHINT_IDX                               = 376,
    SBK_QFLAGS_QT_INPUTMETHODHINT_IDX                        = 131,
    SBK_QT_ENTERKEYTYPE_IDX                                  = 363,
    SBK_QT_TOOLBUTTONSTYLE_IDX                               = 416,
    SBK_QT_LAYOUTDIRECTION_IDX                               = 384,
    SBK_QT_ANCHORPOINT_IDX                                   = 340,
    SBK_QT_FINDCHILDOPTION_IDX                               = 366,
    SBK_QFLAGS_QT_FINDCHILDOPTION_IDX                        = 128,
    SBK_QT_DROPACTION_IDX                                    = 361,
    SBK_QFLAGS_QT_DROPACTION_IDX                             = 126,
    SBK_QT_CHECKSTATE_IDX                                    = 349,
    SBK_QT_ITEMDATAROLE_IDX                                  = 378,
    SBK_QT_ITEMFLAG_IDX                                      = 379,
    SBK_QFLAGS_QT_ITEMFLAG_IDX                               = 133,
    SBK_QT_MATCHFLAG_IDX                                     = 386,
    SBK_QFLAGS_QT_MATCHFLAG_IDX                              = 135,
    SBK_QT_WINDOWMODALITY_IDX                                = 423,
    SBK_QT_TEXTINTERACTIONFLAG_IDX                           = 410,
    SBK_QFLAGS_QT_TEXTINTERACTIONFLAG_IDX                    = 141,
    SBK_QT_EVENTPRIORITY_IDX                                 = 364,
    SBK_QT_SIZEHINT_IDX                                      = 402,
    SBK_QT_WINDOWFRAMESECTION_IDX                            = 422,
    SBK_QT_COORDINATESYSTEM_IDX                              = 354,
    SBK_QT_TOUCHPOINTSTATE_IDX                               = 417,
    SBK_QFLAGS_QT_TOUCHPOINTSTATE_IDX                        = 143,
    SBK_QT_GESTURESTATE_IDX                                  = 370,
    SBK_QT_GESTURETYPE_IDX                                   = 371,
    SBK_QT_GESTUREFLAG_IDX                                   = 369,
    SBK_QFLAGS_QT_GESTUREFLAG_IDX                            = 129,
    SBK_QT_NATIVEGESTURETYPE_IDX                             = 391,
    SBK_QT_NAVIGATIONMODE_IDX                                = 392,
    SBK_QT_CURSORMOVESTYLE_IDX                               = 435,
    SBK_QT_TIMERTYPE_IDX                                     = 413,
    SBK_QT_SCROLLPHASE_IDX                                   = 400,
    SBK_QT_MOUSEEVENTSOURCE_IDX                              = 390,
    SBK_QT_MOUSEEVENTFLAG_IDX                                = 389,
    SBK_QFLAGS_QT_MOUSEEVENTFLAG_IDX                         = 137,
    SBK_QT_CHECKSUMTYPE_IDX                                  = 350,
    SBK_QT_HIGHDPISCALEFACTORROUNDINGPOLICY_IDX              = 373,
    SBK_QT_RETURNBYVALUECONSTANT_IDX                         = 397,
    SBK_QtCoreQT_IDX                                         = 338,
    SBK_QTCOREHELPER_QGENERICARGUMENTHOLDER_IDX              = 427,
    SBK_QTCOREHELPER_QGENERICRETURNARGUMENTHOLDER_IDX        = 428,
    SBK_QTCOREHELPER_QMUTEXLOCKER_IDX                        = 429,
    SBK_QCBORKNOWNTAGS_IDX                                   = 31,
    SBK_QCBORSIMPLETYPE_IDX                                  = 34,
    SBK_QCBORTAG_IDX                                         = 41,
    SBK_QTMSGTYPE_IDX                                        = 430,
    SBK_QtCore_IDX_COUNT                                     = 436
};
...
enum : int {
    ...
    SBK_QTCORE_QPAIR_QSTRING_QSTRING_IDX                     = 19, // QPair<QString,QString >
    SBK_QTCORE_QLIST_QPAIR_QSTRING_QSTRING_IDX               = 20, // QList<QPair< QString,QString > >
    ...
    SBK_QTCORE_QPAIR_QINT64_UNSIGNEDINT_IDX                  = 34, // QPair<qint64,unsigned int >
